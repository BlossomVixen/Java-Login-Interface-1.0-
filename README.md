...
The password must be 8 characters long, the name 4.
email validation is very crude, I only check for a @ and a dot, but ignore duplicates ( keeping it simple, it's a test anyways)
